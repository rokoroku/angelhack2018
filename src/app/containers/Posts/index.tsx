...
const FBShare = ({ href }: { href: string }) => (
  <iframe
...
class PostCreateModal extends React.PureComponent<
  {
...
export class Posts extends React.Component {
  modalRef = React.createRef<PostCreateModal>();
  ...
  render() {
    ...
    return (
      <>
        <Navbar brand="logo" right style={{ paddingLeft: 20 }}>
        ...
        />
        <PostCreateModal ref={this.modalRef} onSubmit={this.onSubmit} />
      </>
    );
  }
}
